...
export class RewardsCommonStartDate extends Contract{
    ...
    deploy(params: IDeployParams): Promise<string>{
        return this.__deploy([params.timeIsMoney,params.token,Utils.toString(params.multiplier),Utils.toString(params.initialReward),Utils.toString(params.vestingStartDate),Utils.toString(params.vestingPeriod),Utils.toString(params.claimDeadline),params.admin]);
    }
    ...
    private assign(){
        ...
        let vestingStartDate_call = async (): Promise<BigNumber> => {
